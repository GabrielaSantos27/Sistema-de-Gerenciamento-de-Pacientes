    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('paciente', 'Paciente'), ('atendente', 'Atendente'), ('medico', 'Médico')], default='paciente', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estado', models.CharField(choices=[('Waiting', 'Em espera'), ('Being_Attended_to', 'Em atendimento'), ('Attended', 'Atendido'), ('Cancelled', 'Cancelado')], default='Waiting', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('horario', models.CharField(choices=[('1', '07:00 - 07:30'), ('2', '07:30 - 08:00'), ('3', '08:00 - 08:30')], max_length=20)),
